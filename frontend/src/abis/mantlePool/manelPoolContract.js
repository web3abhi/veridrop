export const mantlePoolABI = [
  ...
  { inputs: [], name: "MaximumMETHSupplyExceeded", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "allocateToDeposits", type: "uint256" },
    ],
    name: "allocateETH",
    outputs: [],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "unstakeRequestID", type: "uint256" },
    ],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "contract IMETH", name: "mETH", type: "address" },
          {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "expectedDepositRoot", type: "bytes32" },
    ],
  ...
  },
  {
    inputs: [],
    name: "mETH",
    outputs: [{ internalType: "contract IMETH", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    name: "oracle",
    outputs: [
      { internalType: "contract IOracleReadRecord", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    name: "pauser",
    outputs: [
      { internalType: "contract IPauserRead", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "maximumMETHSupply_", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "minimumStakeBound_", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "bool", name: "isStakingAllowlist_", type: "bool" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "withdrawalWallet_", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "minMETHAmount", type: "uint256" },
    ],
    name: "stake",
    outputs: [],
    stateMutability: "payable",
  ...
  {
    inputs: [
      { internalType: "uint128", name: "methAmount", type: "uint128" },
      { internalType: "uint128", name: "minETHAmount", type: "uint128" },
    ],
    name: "unstakeRequest",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "nonpayable",
