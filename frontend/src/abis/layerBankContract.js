export const LayerBankABI = [
  ...
  {
    inputs: [
      { internalType: "address payable", name: "gToken", type: "address" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "gToken", type: "address" },
      { internalType: "uint256", name: "gAmount", type: "uint256" },
    ],
    name: "redeemToken",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "address", name: "_nftCore", type: "address" }],
    name: "setNftCore",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
